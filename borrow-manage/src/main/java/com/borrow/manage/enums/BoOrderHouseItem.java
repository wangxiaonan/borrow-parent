...
public enum  BoOrderHouseItem {
    ...
    HOUSE_IDCARD_PIC_URL("HOUSE_IDCARD_PIC_URL","身份证图片"),
    HOUSE_PIC_URL("HOUSE_PIC_URL","房产证图片"),
    HOUSE_AUTHORITY_CARD_PIC_URL("HOUSE_AUTHORITY_CARD_PIC_URL","他项权证图片"),
    HOUSE_GUARANTEE_PIC_URL("HOUSE_GUARANTEE_PIC_URL","担保函"),
    HOUSE_LETTER_COMMITMENT_PIC_URL("HOUSE_LETTER_COMMITMENT_PIC_URL","信批承诺函图片"),
